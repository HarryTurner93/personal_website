...
import blocks_fastrcnn from "../../images/object-detection-2/blocks_fastrcnn.png";
import terminology from "../../images/object-detection-2/terminology.png";
import with_dense_proposals from "../../images/object-detection-2/with_dense_proposals.png";
import combined_backbone from "../../images/object-detection-2/combined_backbone.png";
import blocks_fasterrcnn from "../../images/object-detection-2/blocks_fasterrcnn.png";
import blocks_overfeat from "../../images/object-detection-2/blocks_overfeat.png";
import box_parameterisation from "../../images/object-detection-2/box_parameterisation.png";
import anchors from "../../images/object-detection-2/anchors.png";
import anchors_paper from "../../images/object-detection-2/anchors_paper.png";
import anchors_targets from "../../images/object-detection-2/anchor_targets.gif";

const object_detection_faster_rcnn_content =
    <div>
        <h3>Faster R-CNN</h3>
        ...
        <p style={{textIndent: '30px', textAlign: 'left'}}>
            If you've not done so already, I suggest you read the previous post on Fast R-CNN, as this post builds
        ...
        <CaptionedImage image={blocks_fastrcnn} caption="The building blocks of Fast R-CNN."/>
        <p style={{textIndent: '30px', textAlign: 'left'}}>
        ...
        <CaptionedImage image={blocks_overfeat} caption="The building blocks of R-CNN and OverFeat."/>
        <p style={{textIndent: '30px', textAlign: 'left'}}>
        ...
        <CaptionedImage image={blocks_fasterrcnn} caption="The building blocks of Faster R-CNN."/>
        <p style={{textIndent: '30px', textAlign: 'left'}}>
        ...
        <CaptionedImage image={terminology} caption="Faster R-CNN is made up of a Region Proposal Network and a Detector Network."/>
        <p style={{textIndent: '30px', textAlign: 'left'}}>
        ...
        <CaptionedImage image={combined_backbone} caption="The Region Proposal Network and Detector share the same backbone."/>
        <p style={{textIndent: '30px', textAlign: 'left'}}>
            Remember how the Fast R-CNN head received region proposals and feature maps, and it first used an ROI Pooling
            layer to warp all projected feature maps into a fixed length vector before doing classification and regression.
            Well all those pieces exist here, so <i>you already know how the Detector Head works, it's just the Fast R-CNN head.</i>
        </p>
        <p style={{textIndent: '30px', textAlign: 'left'}}>
        ...
        <p style={{textIndent: '30px', textAlign: 'left'}}>
            ...
            object detector as well, it can't just magic proposals from thin air. <i>For now, let's just give it
        ...
        <CaptionedImage image={with_dense_proposals} caption="The Region Proposal Network get's it's proposals from something
        called Anchors, which are a (bit) like dense proposals."/>
        <p style={{textIndent: '30px', textAlign: 'left'}}>
        ...
        <CaptionedImage image={anchors} caption="Dense Box Proposals"/>
        <p style={{textIndent: '30px', textAlign: 'left'}}>
            Look at the image above, our goal is to detect the dog. Selective would
        ...
        <CaptionedImage image={anchors_targets} caption="Equations for computing box coordinates from anchors and network outputs."/>
        <p style={{textIndent: '30px', textAlign: 'left'}}>
...
export default object_detection_faster_rcnn_content;